 ...
 * @author sohan
 */
public class CategoryByParent extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String cat = request.getParameter("parent") + "";
        ...
        List<Category> categorys = categoryService.findByParent(categoryService.find(cat_id), offset, max);
