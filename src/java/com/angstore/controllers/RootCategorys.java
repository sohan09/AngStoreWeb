 ...
 * @author sohan
 */
public class RootCategorys extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Category> categorys = categoryService.findByParentIsNull(offset, max);
        
        ObjectMapper mapper = new ObjectMapper();
        mapper.writeValue(response.getWriter(), categorys);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int offset = parseInt(request.getAttribute("page") + "");
        int max = parseInt(request.getAttribute("size") + "");
        max = Math.min(max, 100);
